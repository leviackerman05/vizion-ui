      ...
      <Tabs defaultValue="subscription" className="w-full">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <Card className="p-6 border-2 border-primary">
              <div className="flex flex-col h-full">
                ...
                <p className="text-muted-foreground mb-4">Perfect for professionals and teams</p>
            ...
            <Card className="p-6">
              <div className="flex flex-col h-full">
                ...
                <p className="text-muted-foreground mb-4">For larger organizations with advanced needs</p>
        ...
        <TabsContent value="billing">
          <div className="h-[400px] flex items-center justify-center border rounded-md">
            <p className="text-muted-foreground">Billing information and history will appear here</p>
          </div>
        </TabsContent>
